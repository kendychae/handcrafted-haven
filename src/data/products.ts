...
export const productsData = [
  ...
  },
  {
    ...
    materials: ['Light cherry wood', 'Food-safe natural oil finish', 'Handcrafted joinery'],
    dimensions: '36" L × 24" W × 30" H',
    careInstructions: 'Wipe clean with damp cloth, re-oil annually for best results',
    shippingInfo: 'Ships within 7-10 business days',
    inStock: true,
    stockCount: 14,
    story: 'Each table is carefully crafted by hand, celebrating the natural light grain and warmth of cherry wood. Perfect for creating cozy dining moments.',
  },
  {
    id: 15,
