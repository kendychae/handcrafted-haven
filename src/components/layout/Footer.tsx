            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-500">Artisan Marketplace</p>
                </div>
              </div>
              <p className="text-neutral-600 mb-6 max-w-md">
                Connecting talented artisans with customers who appreciate authentic,
                handcrafted products. Discover unique items made with passion and skill.
              </p>
