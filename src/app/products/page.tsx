            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="body-small text-neutral-600 mb-3">by {product.artist}</p>
                  ...
                  <button className="btn-ghost text-sm px-4 py-2 opacity-0 group-hover:opacity-100 transition-opacity" aria-label={`Quick view ${product.name}`} title={`Quick view ${product.name}`}>
                    Quick View
                  </button>

                <div className="pt-4 border-t border-neutral-200">
                  <p className="body-small text-neutral-700 font-medium">${product.price.toFixed(2)}</p>
                </div>
              </div>
            </Link>
          ))
