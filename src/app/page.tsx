  ...
  const featuredProducts = [
    {
      ...
      category: "Pottery",
      image:
        "https://images.unsplash.com/photo-1610701596007-11502861dcfa?w=400&h=300&fit=crop&crop=center",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      category: "Textiles",
      image:
        "https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=400&h=300&fit=crop&crop=center",
    },
    {
      id: 4,
    ...
    <>
        ...
        <div className="container section-padding">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="body-large mb-8 max-w-2xl mx-auto">
              ...
              items. Support independent creators and find something truly
              special for yourself or loved ones.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center">
                <div className="heading-3 text-accent-800 mb-1">500+</div>
                <div className="body-small text-neutral-600">
                  Talented Artisans
                </div>
              </div>
              <div className="text-center">
                <div className="heading-3 text-accent-800 mb-1">2,000+</div>
                <div className="body-small text-neutral-600">
                  Unique Products
                </div>
              </div>
              <div className="text-center">
                <div className="heading-3 text-accent-800 mb-1">98%</div>
                <div className="body-small text-neutral-600">
      ...
      <section className="section-padding bg-white">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="heading-2 mb-4">Why Choose Handcrafted Haven?</h2>
            <p className="body-large max-w-2xl mx-auto">
              We&apos;re more than just a marketplace – we&apos;re a community
              celebrating creativity, quality, and authentic craftsmanship.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="body text-neutral-600">
                Every item comes with a unique story. Learn about the artisan,
                their process, and the inspiration behind their craft.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="body text-neutral-600">
                All our artisans are verified and their products undergo quality
                checks to ensure authenticity and craftsmanship.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="body text-neutral-600">
                Join a passionate community of creators and customers who value
                sustainability, uniqueness, and supporting small businesses.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section-padding bg-neutral-50">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="body-large max-w-2xl mx-auto">
              Explore our diverse collection of handcrafted items across various
              categories
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="body-large max-w-2xl mx-auto">
              Discover some of our most popular and recently added treasures
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="body-small text-neutral-600 ml-2">
                      ({product.rating}.0)
                    </span>
                  </div>
      ...
      <section className="section-padding gradient-primary text-white">
        <div className="container text-center">
          ...
          <p className="body-large text-secondary-50 mb-8 max-w-2xl mx-auto opacity-90">
            Whether you&apos;re looking for unique items or want to share your
            craft with the world, Handcrafted Haven is the perfect place to
            start.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/products"
              className="bg-white text-primary-800 hover:bg-neutral-100 px-8 py-4 rounded-lg font-medium transition-colors"
            >
              Start Shopping
            </Link>
            <Link
              href="/become-seller"
              className="border-2 border-white text-white hover:bg-white hover:text-primary-600 px-8 py-4 rounded-lg font-medium transition-colors"
            >
              Become a Seller
            </Link>
          </div>
